...
const ViewGuideTours = () => {
  ...
  const retrieveAllTour = async () => {
    const response = await axios.get(
      "http://localhost:8989/api/tour/fetch/guide-wise?tourGuideId=" + guide.id
    );
  ...
  const deleteTour = (tourId, e) => {
    fetch("http://localhost:8989/api/tour/delete?tourId=" + tourId, {
      method: "DELETE",
      headers: {
                ...
                {tours.map((tour) => {
                  return (
                    <tr>
                      <td>
                        <img
                          src={"http://localhost:8989/api/tour/" + tour.image1}
                          class="img-fluid"
                          alt="event_pic"
                          style={{
                            maxHeight: "90px",
