...
const ViewAllEvents = () => {
  ...
  const retrieveAllEvent = async () => {
    const response = await axios.get(
      "http://localhost:8989/api/event/fetch/all?status=Active"
    );
  ...
  const deleteEvent = (eventId) => {
    fetch("http://localhost:8989/api/event/delete?eventId=" + eventId, {
      method: "DELETE",
      headers: {
                ...
                {allEvents.map((event) => {
                  return (
                    <tr>
                      <td>
                        <img
                          src={"http://localhost:8989/api/event/" + event.image}
                          class="img-fluid"
                          alt="event_pic"
                          style={{
                            maxWidth: "90px",
